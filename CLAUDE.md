...
4. `progress.txt` is the append-only log of what happened.
...
5. **Autonomy > questions** — if uncertain, choose the simplest safe assumption and document it in `docs/ISSUES.md`.
